...
func simulation(g,m,u,b,alfa,v float64) (){
	...
	fmt.Println(y_prev*meters_to_pixels)
	fmt.Println(x_prev*meters_to_pixels)

	for i:=1;y_prev>=0 && y_prev*meters_to_pixels<=600 && x_prev>=0 && x_prev*meters_to_pixels<=800;i++{
...
func plot_xy(t_result,x_result,y_result[]float64) {
...
func plot_v(t_result,vx_result,vy_result[]float64) {
...
func plot_a(t_result,ax_result,ay_result[]float64) {
...
func main () {
	parameterWindow()
	pixelgl.Run(run)
	plot_xy(t_result,x_result,y_result)
	plot_v(t_result,vx_result,vy_result)
	plot_a(t_result,ax_result,ay_result)
}
